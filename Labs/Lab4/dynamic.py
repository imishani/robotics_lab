...
with open('../Lab6/TB.pkl', 'rb') as h:
    Tb1, Tb2, Tb3, Tb4, Tb5, Tb6 = pickle.load(h)

with open('../Lab6/Inertia.pkl', 'rb') as h:
...
class Dynamics():
    ...
    def inertia(self):
        ...
        self.self.J1[3:6,0] = np.cross(w101, B1)
    ...
    def coriolis(self, q, qp):
        ...
        self.J2d2 = np.zeros(6)
        self.J3d2 = np.zeros(6)
        self.J4d2 = np.zeros(6)
        self.J5d2 = np.zeros(6)
        self.J6d2 = np.zeros(6)
