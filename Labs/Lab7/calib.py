...
def calibrate(dirpath, square_size, width, height, visualize=False):
    ...
    images = images = glob.glob(dirpath) #os.listdir(dirpath)
...
if __name__ == '__main__':
    ...
    dirpath = 'C://Users/admin/Documents/robotics_lab/Labs/common/Aruco_Tracker-master/calib_images/tests/*.jpg' #args['dir']
    # 2.4 cm == 0.024 m
    # square_size = 0.024
    square_size = 0.024 #args['square_size']

    width = 9 #args['width']
    height = 6 # args['height']
